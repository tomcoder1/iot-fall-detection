...
CLASSIFIER_CONFIG = ClassifierConfig(
    ...
    min_body_area=0.0,
    # Out-of-distribution guard. Pi training maxima were body area 0.372,
    # shoulder span 0.297, and face span 0.155 in normalized coordinates.
    max_body_area=0.42,
    max_shoulder_span=0.32,
    max_face_span=0.18,
    blocked_frame_std=4.0,
    blocked_dark_mean=12.0,
    blocked_bright_mean=245.0,
